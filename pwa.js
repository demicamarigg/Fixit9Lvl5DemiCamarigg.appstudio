...
const cacheName = 'Fixit9Lvl5DemiCamarigg-2020-10-24 13:41:15.325580'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit9Lvl5DemiCamarigg'.length) === 'Fixit9Lvl5DemiCamarigg') {
